    ...
    <>
      ...
      <div className="gl-term relative z-10 shadow-2xl">
        <div className="gl-bar">
          ...
          <span style={{ marginLeft: 'auto', fontSize: '9px', color: 'rgba(255,255,255,0.18)', letterSpacing: '0.12em' }}>
        ...
        <div className="gl-body">
          <div className="gl-line">
            ...
            <span className="gl-code cm"># ── GradeLoop Assessment Engine v2.4 ──</span>
          </div>
          <div className="gl-line">
            <span className="gl-ln">2</span>
            <span className="gl-code">
              <span className="k">import</span> <span className="n">gradeloop</span> <span className="k">as</span> <span className="n">gl</span>
            </span>
          </div>
          <div className="gl-line">
          ...
          <div className="gl-line">
            ...
            <span className="gl-code">
              <span className="op">@</span><span className="n">gl</span><span className="op">.</span><span className="fn">pipeline</span><span className="op">(</span><span className="v">mode</span><span className="op">=</span><span className="s">"strict"</span><span className="op">)</span>
            </span>
          </div>
          <div className="gl-line">
            <span className="gl-ln">5</span>
            <span className="gl-code">
              <span className="k">async def</span> <span className="fn">assess</span><span className="op">(</span><span className="v">submission</span><span className="op">, </span><span className="v">rubric</span><span className="op">):</span>
            </span>
          </div>
          <div className="gl-line">
            <span className="gl-ln">6</span>
            <span className="gl-code indent1 cm"># Static analysis + AST parser</span>
          </div>
          <div className="gl-line">
            <span className="gl-ln">7</span>
            <span className="gl-code indent1">
              <span className="v">ast</span> <span className="op">=</span> <span className="n">gl</span><span className="op">.</span><span className="fn">parse_ast</span><span className="op">(</span><span className="v">submission</span><span className="op">.</span><span className="v">code</span><span className="op">)</span>
            </span>
          </div>
          <div className="gl-line">
          ...
          <div className="gl-line">
            ...
            <span className="gl-code indent1 cm"># LLM-powered feedback & grading</span>
          </div>
          <div className="gl-line">
            <span className="gl-ln">10</span>
            <span className="gl-code indent1">
              <span className="v">feedback</span> <span className="op">=</span> <span className="k">await</span> <span className="n">gl</span><span className="op">.</span><span className="n">llm</span><span className="op">.</span><span className="fn">analyze</span><span className="op">(</span>
            </span>
          </div>
          <div className="gl-line">
            <span className="gl-ln">11</span>
            <span className="gl-code indent2">
              <span className="v">code</span><span className="op">=</span><span className="v">submission</span><span className="op">.</span><span className="v">code</span><span className="op">, </span><span className="v">ast</span><span className="op">=</span><span className="v">ast</span>
            </span>
          </div>
          <div className="gl-line">
          ...
          <div className="gl-line">
            ...
            <span className="gl-code indent1">
              <span className="k">return</span> <span className="n">gl</span><span className="op">.</span><span className="fn">Result</span><span className="op">(</span><span className="v">feedback</span><span className="op">, </span><span className="v">rubric</span><span className="op">)</span>
            </span>
          </div>

          <div className="gl-divider"></div>

          <div style={{ fontSize: '9px', letterSpacing: '0.1em', color: 'rgba(255,255,255,0.2)', textTransform: 'uppercase', marginBottom: '8px' }}>── run output ─────────────────────────────</div>

          <div className="gl-output">
            <div className="gl-row">
              <span className="gl-badge badge-pass">PASS</span>
              <span style={{ color: 'rgba(255,255,255,0.7)' }}>Overall score</span>
              <div className="gl-score-bar" id="bar-overall"><div className="gl-score-fill" id="fill-overall" style={{ width: '0%', background: 'linear-gradient(90deg,#22c55e,#4ade80)' }}></div></div>
              <span style={{ color: '#4ade80', fontWeight: 700, minWidth: '35px', textAlign: 'right' }} id="score-overall">87/100</span>
            </div>
            <div className="gl-row">
              <span className="gl-badge badge-pass">PASS</span>
              <span style={{ color: 'rgba(255,255,255,0.5)' }}>Correctness</span>
              <div className="gl-score-bar" id="bar-cor"><div className="gl-score-fill" id="fill-cor" style={{ width: '0%', background: '#22c55e' }}></div></div>
              <span style={{ color: 'rgba(255,255,255,0.5)', minWidth: '35px', textAlign: 'right' }}>95/100</span>
            </div>
            <div className="gl-row">
              <span className="gl-badge badge-warn">WARN</span>
              <span style={{ color: 'rgba(255,255,255,0.5)' }}>Code style</span>
              <div className="gl-score-bar"><div className="gl-score-fill" style={{ width: '72%', background: '#f59e0b' }}></div></div>
              <span style={{ color: 'rgba(255,255,255,0.5)', minWidth: '35px', textAlign: 'right' }}>72/100</span>
            </div>
          </div>

          <div style={{ marginTop: '10px', fontSize: '9px', letterSpacing: '0.1em', color: 'rgba(255,255,255,0.2)', textTransform: 'uppercase', marginBottom: '6px' }}>── adaptive hints ──────────────────────────</div>

          <div className="gl-hint">
            <span className="gl-hint-num">H1</span>
            <span style={{ color: '#c4b5fd' }}>naming</span> — Variable <span style={{ color: '#ffa657' }}>r</span> is single-character; prefer <span style={{ color: '#ffa657' }}>result</span>.
          </div>
          <div className="gl-hint">
            <span className="gl-hint-num">H2</span>
            <span style={{ color: '#c4b5fd' }}>perf</span> — Nested loop is O(n²). Consider a hash map to bring it down to O(n).
          </div>

          <div className="gl-stats">
            <div className="gl-stat">
              <div className="gl-stat-label">Latency</div>
              <div className="gl-stat-val" style={{ color: '#4ade80' }}>1.2<span style={{ fontSize: '10px', fontWeight: 400, color: 'rgba(255,255,255,0.3)' }}>s</span></div>
            </div>
            <div className="gl-stat">
              <div className="gl-stat-label">Tokens</div>
              <div className="gl-stat-val" style={{ color: '#38bdf8' }}>2.4<span style={{ fontSize: '10px', fontWeight: 400, color: 'rgba(255,255,255,0.3)' }}>k</span></div>
            </div>
            <div className="gl-stat">
              <div className="gl-stat-label">Hints</div>
              <div className="gl-stat-val" style={{ color: '#a78bfa' }}>2<span style={{ fontSize: '10px', fontWeight: 400, color: 'rgba(255,255,255,0.3)' }}>/2</span></div>
            </div>
          </div>

          <div style={{ marginTop: '10px', display: 'flex', alignItems: 'center', gap: '8px', fontSize: '10px', color: 'rgba(255,255,255,0.25)' }}>
            <span className="live-dot"></span>
            <span>pipeline finished</span>
            <span style={{ marginLeft: 'auto', color: 'rgba(74,222,128,0.6)' }}>exit code 0</span>
